...
const Article2 = () => {
  return (
    <>
      <Helmet>
        <title>Comunicação não Violenta jamais vai ser perfumaria | Filipe Chicarino</title>
        <meta name="description" content="A Comunicação Não Violenta tira a comunicação do campo do conflito e a coloca no campo da eficiência" />
      </Helmet>
