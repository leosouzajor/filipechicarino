...
const Article5 = () => {
  return (
    <>
      <Helmet>
        <title>A engenharia do prejuízo | Filipe Chicarino</title>
        <meta name="description" content="O impacto do vício em apostas virtuais na saúde pública e na economia do Brasil" />
      </Helmet>
        ...
        <article className="pt-40 pb-24 px-4 md:px-8 lg:px-16">
          <div className="container mx-auto max-w-4xl bg-white p-8 md:p-16 rounded-2xl shadow-sm">
            ...
            <div className="mb-12 rounded-xl overflow-hidden shadow-sm">
              <img 
                src="https://horizons-cdn.hostinger.com/c9c44d5a-7b6c-49a2-a669-295003b83b7f/1be0c6d2b22fe71329d7a6f22c418606.jpg" 
