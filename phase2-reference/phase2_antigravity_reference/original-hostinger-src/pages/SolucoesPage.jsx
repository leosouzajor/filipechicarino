...
const SolucoesPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Soluções | Filipe Chicarino</title>
        <meta name="description" content="Conheça nossas soluções em palestras, treinamentos, produção audiovisual e consultoria NR-1." />
      </Helmet>
      ...
      <div className="min-h-screen bg-[#F5F3EF]">
        ...
        <EditorialSection
          ...
          image="https://horizons-cdn.hostinger.com/c9c44d5a-7b6c-49a2-a669-295003b83b7f/30a650835d7acecf80ffcc0a232cdb55.jpg"
        ...
        <EditorialSection
          ...
          image="https://horizons-cdn.hostinger.com/c9c44d5a-7b6c-49a2-a669-295003b83b7f/170c6ae1e024a265a1360215d1bf9e3b.jpg"
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-16 mb-16 items-start">
              <div>
                ...
                <div className="mt-8">
                  <img 
                    src="https://horizons-cdn.hostinger.com/c9c44d5a-7b6c-49a2-a669-295003b83b7f/846408bd410957795658b680ef736a58.jpg" 
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              <div className="grid lg:grid-cols-2">
                <div className="p-10 md:p-14 lg:p-20 space-y-8 flex flex-col justify-center">
                  ...
                  <Link to="/#contato" className="inline-flex items-center justify-center gap-2 border-2 border-[#001F3F] text-[#001F3F] px-8 py-4 rounded-lg font-semibold hover:bg-[#001F3F] hover:text-white transition-all duration-300 w-full md:w-auto mt-6">
