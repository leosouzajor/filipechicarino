...
const QuemSouPage = () => {
  return (
    <>
      <Helmet>
        <title>Quem Sou | Filipe Chicarino - O Facilitador</title>
        <meta name="description" content="Saiba mais sobre Filipe Chicarino, facilitador de comunicação com 20 anos de experiência, Mestre em Sociologia Política e especialista em CNV." />
      </Helmet>
      ...
      <div className="min-h-screen bg-[#F5F3EF]">
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="grid lg:grid-cols-12 gap-16 items-start">
              ...
              <div className="lg:col-span-5 relative top-0 lg:-mt-40 z-20">
                ...
                >
                  <img 
                    src="https://horizons-cdn.hostinger.com/c9c44d5a-7b6c-49a2-a669-295003b83b7f/56117ad5fadf793022a65f1ff928e574.jpg" 
        ...
        <section className="py-32 bg-[#001F3F] text-white text-center px-4 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl relative z-10">
            ...
            <Link to="/#contato" className="inline-flex items-center gap-3 bg-[#F5F3EF] text-[#001F3F] px-10 py-5 rounded-lg font-bold text-lg hover:bg-[#C85A3A] hover:text-white transition-all duration-300 shadow-2xl hover:scale-105">
              VAMOS CONVERSAR
