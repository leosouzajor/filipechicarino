...
export const Route = createFileRoute('/blog/a-reuniao-fantasma-voce-esta-presente-ou-apenas-conectado')({
  head: () => ({
    meta: [
      { title: "A Reunião Fantasma: você está presente ou apenas conectado? | Filipe Chicarino" },
      {
        name: "description",
